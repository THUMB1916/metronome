...
"QSlider::handle:horizontal{width:13px;margin-top:-3px;margin-bottom:-3px;border-radius:6px;background:qradialgradient(spread:pad,cx:0.5,cy:0.5,radius:0.5,fx:0.5,fy:0.5,stop:0.6 #FFFFFF,stop:0.8 #1ABC9C);}")
        ...
        self.button_dec_bpm.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.button_inc_bpm.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.radio_standard = QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.radio_standard.setFont(font)
        self.radio_standard.setObjectName("radio_standard")
        self.horizontalLayout_6.addWidget(self.radio_standard)
        ...
        self.radio_customized = QtWidgets.QRadioButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.radio_customized.setFont(font)
        self.radio_customized.setObjectName("radio_customized")
        self.horizontalLayout_5.addWidget(self.radio_customized)
        self.edit_beat_definition = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        self.edit_beat_definition.setFont(font)
        self.edit_beat_definition.setObjectName("edit_beat_definition")
        self.horizontalLayout_5.addWidget(self.edit_beat_definition)
        ...
        self.horizontalLayout_5.addWidget(self.combo_sound)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_standard.setText(_translate("MainWindow", "标准节拍"))
        ...
        self.radio_customized.setText(_translate("MainWindow", "自定义节拍"))
